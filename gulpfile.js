...
gulp.task('ship-to-gitlab', function (done) {
    ...
    var gitPath = 'https://' + user + ':' + token + `@gitlab.syncfusion.com/content/asp.net-core-docs`;
    console.log('Clone has been started...!');
    var clone = shelljs.exec('git clone ' + gitPath + ' -b ' + branch + ' ' + `../../../gitlabRepo/asp.net-core-docs`, {
        silent: false
    });
    if (clone.code !== 0) {
        ...
        for (var changedFileName of changedFileNames.split(',')) {
            ...
            if (changedFileName !== null && changedFileName !== '') {
                ...
                if (fs.existsSync('../asp.net-core-docs/' + changedFileName)) {
                    ...
                    if (fs.existsSync('../../../gitlabRepo/asp.net-core-docs/' + changedFileName)) {
                        shelljs.cp('-rf', `../asp.net-core-docs/` + changedFileName, `../../../gitlabRepo/asp.net-core-docs/` + changedFileName);
                    }
                    else {
                        // It will update the newly added files
                        if (fs.existsSync('../../../gitlabRepo/asp.net-core-docs/')) {
                            shelljs.cp('-rf', `../asp.net-core-docs/` + changedFileName, `../../../gitlabRepo/asp.net-core-docs/` + changedFileName);
                        }
                    }
                    ...
                    if (fs.existsSync('../../../gitlabRepo/asp.net-core-docs/' + changedFileName)) {
                        shelljs.rm('-rf', `../../../gitlabRepo/asp.net-core-docs/` + changedFileName);
