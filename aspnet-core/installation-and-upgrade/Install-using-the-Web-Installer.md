...
The following procedure illustrates how to install Essential Studio ASP.NET Core Online Installer. 

1.  Double-click the Syncfusion Essential Studio ASP.NET Core Online Installer file. The installer Wizard opens and extracts the package automatically.
...
The following procedure illustrates how to uninstall Essential Studio ASP.NET Core from Web Installer. 
...
The following procedure illustrates how to install/uninstall Essential Studio ASP.NET Core from Web Installer. 
