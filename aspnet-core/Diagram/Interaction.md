...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img1.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img2.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img3.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img4.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img5.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img6.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img7.png)

* When necessary, some segments are added or removed automatically, when dragging the segment. This is to maintain proper routing of orthogonality between segments.

![](/aspnet-core/Diagram/Interaction_images/Interaction_img8.png)

### Bezier thumbs

* Bezier segments are annotated with two thumbs to represent the control points. Control points of the curve can be configured by clicking and dragging the control thumbs.

![](/aspnet-core/Diagram/Interaction_images/Interaction_img9.png)
...
{% highlight razor %}
    ...
    <ej-diagram id="diagram" width="900px" height="600px">
      <e-nodes>
        <e-node name="node1" width="100" height="100" offset-x="100" offset-y="100" fill-color="#1BA0E2" constraints="Default|NodeConstraints.AllowDrop"></e-node>
      </e-nodes>
      <e-connectors>
        <e-connector name="connector1" constraints="Default|ConnectorConstraints.AllowDrop">
...
{% highlight razor %}
    ...
    <ej-diagram id="diagram" width="900px" height="600px" drop="ondrop"></ej-diagram>
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img10.png)
...
![](/aspnet-core/Diagram/Interaction_images/Interaction_img11.png)
