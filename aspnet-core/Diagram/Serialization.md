---
layout: post
title: Serialization | Diagram | ASP.NET CORE | Syncfusion
...
Diagram can also be saved as raster or vector image files. For more information about saving the Diagram as images, refer to [Exporting](/aspnet-core/Diagram/Exporting "Exporting").
...
{% highlight razor %}
    ...
    <ej-diagram id="diagram" width="900px" height="600px" node-collection-change="nodeCollectionChange"></ej-diagram>
